...
from stella.lit.extraction.bibliography import discover_bibliography
from stella.lit.extraction.cleaning import (
    render_manuscript_view,
    strip_tex_comments,
)
from stella.lit.extraction.ecsv import SelectedEcsv, select_ecsv_tables
from stella.lit.extraction.method_config import HvsContextBudget
from stella.lit.extraction.tex_graph import TexGraphError, resolve_tex_graph
...
def numbered_lines(content: str) -> str:
    """Render text with stable 1-based line numbers for evidence locators."""
