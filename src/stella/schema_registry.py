...
SCHEMAS: tuple[SchemaEntry, ...] = (
    ...
    _entry("benchmark.hvs_extraction_scratch.run_config", 1, lifecycle="transient"),
    _entry("benchmark.hvs_extraction_scratch.prepared_input", 1, lifecycle="transient"),
    _entry("benchmark.hvs_extraction_scratch.roster_proposal", 1, lifecycle="transient"),
    _entry("benchmark.hvs_extraction_scratch.roster_final", 1, lifecycle="transient"),
    _entry("benchmark.hvs_extraction_scratch.candidate_fields", 1, lifecycle="transient"),
    _entry("benchmark.hvs_extraction_scratch.paper_result", 1, lifecycle="transient"),
    _entry("benchmark.hvs_extraction_scratch.run_summary", 1, lifecycle="transient"),
