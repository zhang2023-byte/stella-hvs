...
class SchemaRegistryTests(unittest.TestCase):
    ...
    def test_current_persisted_contract_versions_are_current_and_old_versions_readable(self):
        expected = {
            ...
            "benchmark.network_debug_config": (1, (1,)),
            "benchmark.network_debug_state": (1, (1,)),
            "benchmark.network_debug_result": (1, (1,)),
            "benchmark.network_debug_event": (1, (1,)),
            "benchmark.scorecard": (8, (2, 3, 4, 5, 6, 7, 8)),
            "benchmark.model_pricing_snapshot": (1, (1,)),
            "benchmark.scoring_details": (5, (2, 3, 4, 5)),
            "literature_hvs_candidates": (3, (1, 2, 3)),
            "literature_hvs_contributions": (2, (1, 2)),
            ...
            "benchmark.hvs_contribution_annotation": (2, (1, 2)),
            "benchmark.hvs_contribution_form_draft": (1, (1,)),
            "benchmark.hvs_contribution_scorecard": (2, (1, 2)),
            "benchmark.hvs_contribution_scoring_details": (2, (1, 2)),
