...
class WorkflowPlanTest(unittest.TestCase):
    ...
    def test_gold_revision_plan_preserves_the_current_sha_pin(self) -> None:
        self._write_request(
            {
                "expert": "expert-a",
                "papers": ["2601.08888"],
