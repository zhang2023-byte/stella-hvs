...
class HvsCatalogSiteTest(unittest.TestCase):
    def test_snapshot_loads_catalog_and_counts_objects(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            write_json(
                ...
                {
                    "schema": {"name": "hvs_candidate_catalog.index", "version": 1},
                    "summary": {
                        "object_count": 1,
                        "source_count": 2,
                        "candidate_count": 2,
            ...
            self.assertEqual(snapshot["schema"], {"name": "hvs_catalog_site.snapshot", "version": 1})
    ...
    def test_snapshot_ignores_old_object_schema_versions(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            old_record["schema"] = {"name": "hvs_candidate_catalog.object", "version": 2}
