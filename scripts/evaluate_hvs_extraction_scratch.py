#!/usr/bin/env python3
"""Evaluate one immutable scratch dev run against the external private gold."""
...
def cli() -> int:
    try:
        ...
        print(f"scratch evaluation refused: {exc}", file=sys.stderr, flush=True)
        return 2
