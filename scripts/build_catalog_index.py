#!/usr/bin/env python3
"""Build the global catalog review index from per-paper review JSON files."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build literature/catalog_index.json and literature/catalog_index.md.")
...
def main() -> int:
    ...
    print(
        ...
        f"{summary['has_catalog_count']} with catalog candidates, "
